...
export const Where = ({ invoiseList, flight, timeArrival, fromGA, dateArrival, typeAct }) => {
    ...
    return (
        <span class="content-header">
            ...
            {
                (fromGA && typeAct === "type52") && <div class="content-header-item"><span class="content-header-indent">От</span> органов ГА {`${day}.${mounthNumber}.${year}г.`} в {hours}ч. {minutes}мин.  без сопроводительных документов поступили следующие емкости и РПО:
                </div>
            }
            {
                (fromGA && typeAct === "tp51-d") && <span class="content-header-item"><span class="content-header-indent">От</span> органов ГА {`${day}.${mounthNumber}.${year}г.`} в {hours}ч. {minutes}мин.  без сопроводительных документов 
                </span>
            }
        </span>
    )
