...
export const Where = ({invoiseList, flight, timeArrival, fromGA, withoutDocuments, dateArrival, typeAct}) => {
    ...
    return (
        <span class="content-header">
            {invoiseList.length === 1 && <div class="content-header-item"><span
                class="content-header-indent">С</span> рейса {flight?.number ?? " "} из {flight?.city ?? " "} в {hours}ч. {minutes}мин.
            ...
            }
            {
                ...
                <div class="content-header-item"><span class="content-header-indent">От</span> органов
                    ГА {`${day}.${mounthNumber}.${year}г.`} в {hours}ч. {minutes}мин. без сопроводительных документов
            ...
            }
            {
                (fromGA && typeAct === "tp51-d") && <span class="content-header-item"><span
                    class="content-header-indent">От</span> органов ГА {`${day}.${mounthNumber}.${year}г.`} в {hours}ч. {minutes}мин.  без сопроводительных документов
                </span>
            }
        </span>
    )
