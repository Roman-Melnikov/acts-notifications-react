...
export const InvoiseListOutputItem = ({ invoiseListOutputItem, invoiseListOutputLength, index }) => {
    return (
        <p class="content-header-indent-some">
            <span class="content-header-span-indent">- </span>№{invoiseListOutputItem.number} на {invoiseListOutputItem.thingAmount} вещей вес {invoiseListOutputItem.totalWeight}кг
